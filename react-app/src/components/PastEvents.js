...
import "./styling/pastEventsStyle.css";
...
const PastEvent = ({ id }) => {
  ...
  return (
    <>
      <div className="past-event-results">
        <div
        ...
        >
          {sessionEvent &&
            pastEvents?.map((pastEvent, i) => (
              <div className="event-cards" key={pastEvent.id}>
                <button
                  htmlType="submit"
                  type="text"
                  size="medium"
                ...
                >
                  <Card
                    ...
                    cover={
                      <img
                        alt={pastEvent.event_date.slice(0, 16)}
            ...
            >
              {pastEvents && pastEvents.length > 0 && (
                <Meta
                  ...
                  title={pastEvents[modalEvent].event_date.slice(0, 16)}
                  description={pastEvents[modalEvent].event_city}
