    ...
    <>
      <div className="about">
        ...
        <div className="about-text">
          ...
          <br></br>
          <br></br>
          When Wine Party was conceived, it wasn't just about wine. It was truly about connection.
          ...
          and perspective on their favorite wine. Or perhaps learning about the
